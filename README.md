...
This repo contains scripts applying marp to real-world data, pipelines to transform said data and code for a simulation study to evaluate marp method on a generated sample.
